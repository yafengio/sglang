...
sources = [
    ...
    "csrc/elementwise_musa/concat_mla.mu",  # "csrc/elementwise/concat_mla.mu",
    "csrc/elementwise_musa/fused_add_rms_norm_kernel.mu",  # "csrc/elementwise/fused_add_rms_norm_kernel.cu",
